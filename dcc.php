...
class dcc
{
    ...
    public function addChat($nick, $host, $port, $admin, $handler, $fromTimer = false) {
        ...
        $chat->setMemClass($this->memClass);
    ...
    // <-- ignore fromTimer, it is sent by reverseTimer() above
    {
        $reverse = false;
    ...
    public function reverseTimer($args) {
        ...
        if ($memData == NULL || ($memData->host == "" || $memData->host == NULL)) {
            ...
            if ($args->arg8 == FILE) {
                $this->addFile($args->arg1, $memData->host, $this->ircClass->getClientConf("mircdccreverse"), $args->arg4, $args->arg5, $args->arg6, true);
            } 
            else {
                $this->addChat($args->arg1, $memData->host, $this->ircClass->getClientConf("mircdccreverse"), $args->arg4, $args->arg5, true);
            }
        }
