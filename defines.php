...
if ($OS == 'unknown') {
    ...
    define('EAGAIN', 10035);
     //EWOULDBLOCK.. kinda like EAGAIN in windows?
...
// Timer declarations
define('NICK_CHECK_TIMEOUT', 120);
 //seconds
define('CHAN_CHECK_TIMEOUT', 60);
 //seconds
define('PING_TIMEOUT', 130);
 //seconds (check every 130 seconds if we're still connected)
...
define('HIGHEST_PORT', 1000);
 // this is tcpRangeStart + HIGHEST_PORT
...
class socketInfo
{
    ...
    public $class;
    public $func;
    public $readScheduled;
     //Used so we don't add infinite queues to the process queue.
...
class queueItem
{
    ...
    public $callBack_class;
     //CALL BACK class/function to use
    public $callBack_function;
    public $nextRunTime;
     //The next getMicroTime() time to run
    public $removed;
    public $next;
    public $prev;
}
