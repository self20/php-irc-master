...
class quotes_mod extends module
{
    ...
    public function priv_addquote($line, $args) {
        ...
        if ($args['nargs'] == 0) {
            ...
            $values = array($quoteText, $channel,);
            ...
            if (!$this->db->numRows($quoteRaw)) {
                ...
                $values = array($line['fromNick'], $quoteText, $channel,);
    ...
    public function priv_undelete($line, $args) {
        ...
        if (!$this->ircClass->isMode($line['fromNick'], $channel, "o") && !$this->ircClass->isMode($line['fromNick'], $channel, "a") && !$this->ircClass->isMode($line['fromNick'], $channel, "q")) {
            return;
        }
    ...
    public function priv_findquote($line, $args) {
        ...
        if ($args['nargs'] == 0) {
            ...
            $values = array($type, $search, $channel,);
