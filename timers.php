...
class timers
{
    ...
    //Local variables
    private $timerStack = array();
    
    //list of all timers indexed by name
    ...
    //use these names)
    private $reserved = array("listening_timer_[0-9]*", "check_nick_timer", "check_channels_timer", "check_ping_timeout_timer",);
